...
import com.xxx.xcloud.module.ci.service.impl.ICiServiceImpl;
    ...
    private void updateImageVersonCodeBaseNameInfo(ImageVersion imageVersion) {
        try {
            ...
            imageVersion.setCodeBaseName(
                    ICiServiceImpl.generateCodeBaseName(ciCodeCredentials, codeInfo, ci.getTenantName()));
        ...
        try {
            ...
            codeCheckResults.forEach((codeCheckResult) -> {
                codeCheckResult.setCodeBaseName(
                        ICiServiceImpl.generateCodeBaseName(ciCodeCredentials, codeInfo, codeCheckTask.getTenantName()));
            });
