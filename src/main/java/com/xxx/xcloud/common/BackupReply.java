...
public class BackupReply {
    ...
    private static Logger logger = LoggerFactory.getLogger(BackupReply.class);
    ...
    private static final Integer[] BACKUPTASKTYPES = new Integer[] { BackupReply.JOB_TYPE_FULL_AMOUNT_BACKUP,
            BackupReply.JOB_TYPE_INCREMENTAL_BACKUP };
    ...
    public static String getJobTypeName(Integer jobType) {
        ...
        switch (jobType) {
        // 全量备份
        case BackupReply.JOB_TYPE_FULL_AMOUNT_BACKUP:
            jobTypeName = BackupReply.JOB_TYPE_FULL_AMOUNT_BACKUP_NAME;
            break;
        // 增量备份
        case BackupReply.JOB_TYPE_INCREMENTAL_BACKUP:
            jobTypeName = BackupReply.JOB_TYPE_INCREMENTAL_BACKUP_NAME;
            break;

        // 恢复
        case BackupReply.JOB_TYPE_RECOVER:
            jobTypeName = BackupReply.JOB_TYPE_RECOVER_NAME;
            break;
