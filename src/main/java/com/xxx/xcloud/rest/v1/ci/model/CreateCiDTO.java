...
public class CreateCiDTO {
    ...
    @ApiModelProperty(value = "构建类型", required = true, example = "1代码构建 2DockerFile构建", dataType = "byte")
    private Byte ciType;

    @ApiModelProperty(value = "构建任务名称", required = true, example = "testCi", dataType = "String")
    private String ciName;

    @ApiModelProperty(value = "镜像名称", required = true, example = "testImage", dataType = "String")
    private String imageName;

    @ApiModelProperty(value = "镜像版本", required = false, example = "v1", dataType = "String")
    private String imageVersion;

    @ApiModelProperty(value = "镜像版本前缀", required = false, example = "v", dataType = "String")
   ...
   //todo @Env
    @ApiModelProperty(value = "镜像环境变量", required = false, example = "", dataType = "String")
