 ...
 *
 */
@ApiModel(value = "http代理创建相关参数")
@Data
public class IngressProxyCreateModelDTO {

    @ApiModelProperty(value = "是否使用高级参数,0:不使用,1:使用", required = true, example = "testdomain", dataType = "Byte")
