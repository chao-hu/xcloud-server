...
/**
 * @ClassName: PostgresqlCreateDTO
 * @Description: postgresql创建DTO
 * @author lnn
 * @date 2019年11月14日
 *
 */
@Data
@ApiModel(value = "postgresql创建请求模型")
public class PostgresqlCreateDTO {
    ...
    @ApiModelProperty(value = "服务名称", required = true, example = "testpostgresql", dataType = "String")
    @Pattern(regexp = Global.CHECK_SERVICE_NAME, message = "服务名称不符合规范")
    @NotBlank(message = "服务名称不能为空")
    private String serviceName;

    @ApiModelProperty(value = "组件类型", required = true, example = "postgresql", dataType = "String")
    ...
    @ApiModelProperty(value = "类型", required = true, example = "async", dataType = "String")
    @NotBlank(message = "类型不能为空")
    private String type;

    @ApiModelProperty(value = "版本", required = true, example = "10.5.1", dataType = "String")
    ...
    @ApiModelProperty(value = "配置", required = false, example = "{'postgresql.conf':{'ordinary':{'max_connections':'1024'}}}", dataType = "JSONObject")
    private JSONObject configuration;

    @ApiModelProperty(value = "订购ID", required = true, example = "orderId", dataType = "String")
