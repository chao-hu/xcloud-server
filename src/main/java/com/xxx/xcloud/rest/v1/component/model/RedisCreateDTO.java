...
/**
 * @ClassName: RedisCreateDTO
 * @Description: Redis创建DTO
 * @author lnn
 * @date 2019年11月14日
 *
 */
...
@Data
@ApiModel(value = "Redis创建请求模型")
public class RedisCreateDTO {
    ...
    @ApiModelProperty(value = "服务名称", required = true, example = "testredis", dataType = "String")
    @Pattern(regexp = Global.CHECK_SERVICE_NAME, message = "服务名称不符合规范")
    @NotBlank(message = "服务名称不能为空")
    private String serviceName;

    @ApiModelProperty(value = "组件类型", required = true, example = "redis", dataType = "String")
    ...
    @ApiModelProperty(value = "版本", required = true, example = "3.2.11", dataType = "String")
