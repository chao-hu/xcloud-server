...
/**
 * @ClassName: MemcachedOperatorDTO
 * @Description: Memcached操作DTO
 * @author lnn
 * @date 2019年11月13日
 *
 */
@Data
@ApiModel(value = "Memcached操作请求模型")
public class MemcachedOperatorDTO {
    ...
    @ApiModelProperty(value = "新增后总实例数(新增实例必传)", required = false, example = "4", dataType = "int")
