 ...
 */
@Data
@ApiModel(value = "Zk创建请求模型")
public class ZkCreateDTO {
    ...
    @ApiModelProperty(value = "服务名称", required = true, example = "testzk", dataType = "String")
    @Pattern(regexp = Global.CHECK_SERVICE_NAME, message = "服务名称不符合规范")
    @NotBlank(message = "服务名称不能为空")
    private String serviceName;

    @ApiModelProperty(value = "组件类型", required = true, example = "zookeeper", dataType = "String")
    ...
    @ApiModelProperty(value = "版本", required = true, example = "3.4.12", dataType = "String")
